        ...
        <div className="client-theme-settings">
            <div className="client-theme-container">
                <div className="client-theme-settings-labels">
                    <Forms.FormTitle tag="h3">テーマカラー</Forms.FormTitle>
                    <Forms.FormText>Discordクライアントのテーマに色を追加する</Forms.FormText>
                </div>
                <ColorPicker
            ...
            {lightnessWarning || lightModeWarning
                ? <div>
                    ...
                    <Forms.FormText className="client-theme-warning">うーん、あなたのテーマは良く見えません...</Forms.FormText>
                    {lightnessWarning && <Forms.FormText className="client-theme-warning">選択した色は明るすぎます</Forms.FormText>}
                    {lightModeWarning && <Forms.FormText className="client-theme-warning">ライトモードはサポートされていません</Forms.FormText>}
                </div>
                : null
            }
        </div>
...
const settings = definePluginSettings({
    color: {
        description: "Discordクライアントテーマの色。ライトモードはサポートされていません",
        type: OptionType.COMPONENT,
        default: "313338",
        component: () => <ThemeSettings />
    },
    resetColor: {
        description: "テーマカラーをリセットする",
        type: OptionType.COMPONENT,
        default: "313338",
        component: () => (
...
export default definePlugin({
    ...
    description: "昔のクライアントテーマの再現（試験段階）。Discordクライアントテーマに色を追加する",
    settings,
